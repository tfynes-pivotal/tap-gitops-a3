...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-a3
echo     https://github.com/tfynes-pivotal/tap-gitops-a3
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-a3 --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-a3
git branch -M main
